    ...
    <html lang="en">
      ...
      >
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <a
            href="https://wa.me/27603114115?text=Hello! I would like to make a quick reservation or book a massage."
            target="_blank"
            ...
            aria-label="Contact us on WhatsApp for quick reservations and massage bookings"
          >
            <svg
              className="w-8 h-8"
              fill="currentColor"
            ...
            <div className="absolute right-full mr-3 px-3 py-1 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              Quick reservations & massage bookings
            </div>
          </a>
        </div>
