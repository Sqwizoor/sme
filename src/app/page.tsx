...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white overflow-hidden min-h-[80vh] pt-20 md:pt-0 flex items-center">
        ...
        <div className="relative container mx-auto px-4 pt-4 pb-8 md:py-12 lg:py-16">
          <div className="max-w-5xl mx-auto text-center">
            {/* Badge */}
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-amber-400/30 rounded-full px-4 py-2 mb-4 md:mb-6">
              ...
              <span className="text-sm font-medium text-white">Trusted by 500+ South African Businesses</span>
            </div>
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 leading-tight">
              ...
              <span className="block text-amber-400 mb-2">
                Business Advocacy
              </span>
              <span className="block text-slate-100 text-base sm:text-lg md:text-xl mt-1 md:mt-2">
                for Small, Medium & Micro Enterprises
              </span>
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl mb-3 md:mb-4 text-amber-300 font-bold">
              Justice for Small Medium & Micro Enterprises (JSMMEs)
            </p>
            
            <p className="text-sm sm:text-base md:text-lg mb-4 md:mb-6 text-slate-100 max-w-4xl mx-auto leading-relaxed px-2">
              We provide comprehensive industrial relations, CCMA support, government lobbying, 
              and business advocacy services specifically designed for SMMEs across South Africa.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md: gap-4 justify-center mb-4 md:mb-6 px-2">
              ...
              <Link 
                href="/services" 
                className="group bg-brown-700 hover:bg-brown-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-brown-600"
              >
                <span className="flex items-center justify-center text-sm md:text-base">
                  📋 Learn More
                  <svg className="w-4 h-4 md:w-5 md:h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-xs text-slate-100">Member Businesses</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-amber-400 mb-1">11</div>
                <div className="text-xs text-slate-100">Industry Sectors</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-amber-400 mb-1">24/7</div>
                <div className="text-xs text-slate-100">Legal Support</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-amber-400 mb-1">10+</div>
                <div className="text-xs text-slate-100">Years Experience</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* JSMME & SMME CLINIC Detailed Information */}
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 mb-4">in collaboration with</p>
              <h3 className="text-3xl md:text-4xl font-bold text-blue-600">
                SMALL MEDIUM & MICRO ENTERPRISES CLINIC (SMME CLINIC)
              </h3>
            </div>

            {/* FOCUSES */}
            <div className="mb-16">
              <h3 className="text-3xl font-bold text-slate-900 mb-6">FOCUSES</h3>
              <p className="text-slate-700 leading-relaxed text-lg">
                JSMME focuses on the dynamics of conflict and power in the SMME work place, as well as collaboration and co-operation with other entities that share an ideal of giving support to SMMEs to be successful. As such JSMME has established a collaboration and co-operation with SMME CLINIC a company that promotes economic interests of the SMMEs locally, regionally, nationally and internationally on related matters elaborated below.
              </p>
            </div>
            ...
            {/* VALUES */}
            <div className="mb-16">
              <h3 className="text-3xl font-bold text-slate-900 mb-6">VALUES</h3>
              <p className="text-slate-700 leading-relaxed text-lg">
            ...
            {/* SERVICES - Industrial or Labour Relations */}
            <div className="mb-16">
              <h3 className="text-3xl font-bold text-slate-900 mb-6">SERVICES- Industrial or Labour Relations</h3>
              ...
              <div className="space-y-6">
                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">1. Work Grievances:</h4>
                  <p className="text-slate-700 leading-relaxed">address Work Grievances on behalf of SMME owners a range of employee issues related to pay, working conditions, and harassment to discrimination or breaches of contract etc.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">2. Disciplinary inquiry:</h4>
                  <p className="text-slate-700 leading-relaxed">investigate acts of misconducts, initiate or preside   over disciplinary inquiries,</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">3. Arbitration:</h4>
                  <p className="text-slate-700 leading-relaxed">represent Members on all labour dispute referred by an employee or Trade Union to Arbitration related to unfair labour practices, unfair dismissal, or discrimination etc.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">4. Incapacity or poor performance:</h4>
                  <p className="text-slate-700 leading-relaxed">represent members in termination of a contract of employment in instances where an employee is failing to reach and maintain reasonable, lawful  attainable work performance standards expected by the employer</p>
                </div>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">6. Lockouts:</h4>
                  <p className="text-slate-700 leading-relaxed">represent members on lockouts of employees from work premises as offensive tactic to pressure those who refuse to return to work or damage the workplace property,</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">7. Strikes:</h4>
                  <p className="text-slate-700 leading-relaxed">assist members speedily resolve disputes with employees who are engaged in concerted refusal to work, either partially or completely exerting pressure on employers to accept their specific terms or  benefits.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">8. Transfer of business:</h4>
                  <p className="text-slate-700 leading-relaxed">manage transfer of businesses as a going concern where new employer inherits all rights and obligations related to employees condition of employment from old employer</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">9. Collective Bargaining:</h4>
                  <p className="text-slate-700 leading-relaxed">promote and strengthen constructive engagement, mutual trust, understanding, respect and orderly participation of employees in workplace decision-making decrease as disputes are time-consuming, and cause reputational damage, deter customers and investors</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">10. Legal Compliance:</h4>
                  <p className="text-slate-700 leading-relaxed">assist Members comply with labour legislation  and regulations that often result unfair labour practices, discrimination, unfair dismissal, unfair discrimination attracting unnecessary Arbitration compensatory penalties, unjustified settlements or employees filling law suits at Labour Courts</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">11. Human Resource Management:</h4>
                  <p className="text-slate-700 leading-relaxed">create human resource management as a one stop shop for SMMEs that provide recruitment techniques and strategies to attract, select and appoint talent candidates, while promoting safety and health to avert workplace accidents, injuries.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">12. Risk Management:</h4>
                  <p className="text-slate-700 leading-relaxed">early detection of potential risk issues related to workplace safety and health that can lead to accidents, injuries, conflict between employees and management, giving rise to disruption of operations, productivity, absenteeism,  and affect employee morale.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">13. Collective Bargaining:</h4>
                  <p className="text-slate-700 leading-relaxed">negotiate and agree upon collective agreements with trade unions, determining the terms and conditions of employment for security personnel.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">14. Advice and Support:</h4>
                  <p className="text-slate-700 leading-relaxed">offer guidance to members on labour laws, policies, and the practical application of the Main Collective Agreement.</p>
                </div>

                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-brown-600">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">15. Establishment of Benefit Schemes:</h4>
                  <p className="text-slate-700 leading-relaxed">help members establish and administer various benefit schemes for employees, such as pension funds, medical aid, and provident funds.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-16 bg-gradient-to-br from-brown-50 to-slate-50 p-8 rounded-2xl">
              ...
              <p className="text-slate-700 leading-relaxed text-lg font-semibold mb-6">
                SMME CLINIC assist members to:
              </p>

              <div className="space-y-6">
                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">1. Mentorship and Support:</h4>
                  <p className="text-slate-700 leading-relaxed">access mentorship, advice, and support from experienced entrepreneurs or business professionals crucial in navigating challenges and making informed decisions, accessing critical information, communicating with stakeholders, and navigating business bureaucratic processes</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">2. Marketing and Sales:</h4>
                  <p className="text-slate-700 leading-relaxed">enhance marketing and sales strategies that effectively promote SMMEs products or services, analyse market trends and customer needs.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">3. Networking:</h4>
                  <p className="text-slate-700 leading-relaxed">foster collective efficiency through networking to help overcome market access challenges and increase market penetration with aim to boost the participation of rural and township-based enterprises .</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">4. Funding Applications:</h4>
                  <p className="text-slate-700 leading-relaxed">prepare funding applications to meet stringent lending requirements necessary to secure loans, grants or other forms of funding for their business operations and growth.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">5. Tender Procurement:</h4>
                  <p className="text-slate-700 leading-relaxed">prepare compliant tender procurement bidding documents that meet supply chain regulations requirements</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">6. Brand Development:</h4>
                  <p className="text-slate-700 leading-relaxed">develop strong and last brands that can sustain time in a competitive buisness landscapes</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">7. Legal Practitioners:</h4>
                  <p className="text-slate-700 leading-relaxed">secure negotiated affordable and competent legal practitioners with speciality in pursuing specific  legal action or dispute without impacting on their cash flow or  hindering their ability to operate and grow</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">8. Legally Binding Agreements:</h4>
                  <p className="text-slate-700 leading-relaxed">draft legally binding agreements that outlines specific deliverables, quality standards, and expectations between parties, to the achieve defined outcomes.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">9. Strategic Planning:</h4>
                  <p className="text-slate-700 leading-relaxed">create and implement strategic plans intendent to achieve their specific goals through building strong relationships with clients, securing new business stakeholders, fostering long-term partnerships and strong alliances.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">10. Strategic Partnerships:</h4>
                  <p className="text-slate-700 leading-relaxed">facilitate an integrated approach to create strategic partnerships with a range of business institutions.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">11. Internal Policies:</h4>
                  <p className="text-slate-700 leading-relaxed">develop internal policies that reflects future goals and aspirations and provides guidelines for carrying out those goals.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">12. Education Collaboration:</h4>
                  <p className="text-slate-700 leading-relaxed">foster co-operation between educational institutions, their employees, government, private sector to align education with sector needs, as literacy and innumeracy has negatively effect on their businesses efficiencies and productivity.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">13. Government Engagement:</h4>
                  <p className="text-slate-700 leading-relaxed">develop strategies to participate in decision-making processes that affect their interests when engaging with related government departments and municipalities.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">14. International Markets:</h4>
                  <p className="text-slate-700 leading-relaxed">understand international customer preferences, competition, and potential barriers and analyse international performance through a wide range of software, platforms, and techniques, like social media management, email marketing, content creation, and analytics to reach target audiences.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-l-4 border-brown-500">
                  <h4 className="font-bold text-slate-900 text-lg mb-2">15. Ethical Business Practices:</h4>
                  <p className="text-slate-700 leading-relaxed">promote ethical and social business conscious practices amongst our members</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-brown-700 to-brown-600">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-100">
              <div className="bg-gradient-to-br from-brown-600 to-brown-700 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-slate-900 group-hover:text-brown-700 transition-colors">
                Legal Support
              </h3>
            ...
            {/* Advocacy Card */}
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-100">
              <div className="bg-gradient-to-br from-brown-500 to-brown-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900 group-hover:text-brown-600 transition-colors">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {/* Industrial Relations */}
            <div className="group bg-gradient-to-br from-slate-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 hover:border-brown-200">
              <div className="bg-gradient-to-br from-brown-600 to-brown-700 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
                </svg>
            ...
            {/* Workplace Training */}
            <div className="group bg-gradient-to-br from-slate-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 hover:border-brown-200">
              <div className="bg-gradient-to-br from-brown-700 to-brown-800 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-slate-900 group-hover:text-brown-800 transition-colors">
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-8 border border-slate-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  href="/services"
                  className="bg-gradient-to-r from-brown-700 to-brown-800 text-white px-8 py-4 rounded-xl font-bold hover:from-brown-800 hover:to-brown-900 transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
                  View All Services
                </Link>
                <Link 
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="group text-center">
              <div className="bg-gradient-to-br from-brown-600 to-brown-700 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-all duration-300 shadow-lg">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-brown-700 transition-colors">
            ...
            <div className="group text-center">
              <div className="bg-gradient-to-br from-brown-500 to-brown-600 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-all duration-300 shadow-lg">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-brown-600 transition-colors">
            ...
            <div className="group text-center">
              <div className="bg-gradient-to-br from-brown-700 to-brown-800 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-all duration-300 shadow-lg">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-brown-800 transition-colors">
