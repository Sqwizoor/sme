    ...
    return (
      <div className="bg-amber-50 border-l-4 border-amber-600 p-6 rounded-lg">
        <div className="flex items-center">
          <svg className="w-6 h-6 brand-icon mr-3" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
          <div>
            <h3 className="text-lg font-bold text-amber-800 brand-display italic">Thank you for contacting us!</h3>
            <p className="text-amber-700 mt-1">We&apos;ve received your message and will get back to you shortly.</p>
          </div>
        </div>
      </div>
    );
